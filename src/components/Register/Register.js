...
const Register = ({ goWithGoogle }) => {
    return (
        <div className="w-screen h-screen absolute top-0 left-0 bg-black opacity-75">
            <div>
                <div className="bg-white opacity-100 rounded-md px-5 py-2 max-w-lg mx-auto my-10 flex justify-center items-center">
